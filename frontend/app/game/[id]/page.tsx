...
export default function GameReviewPage() {
  ...
  // Labels dos Gráficos (O seu código, sem mudanças)
  ...
  // --- MUDANÇA #1: FUNDO PARA IMAGEM ---
  return (
    // Mudei 'bg-black' para 'relative' para o fundo funcionar
    <main className="relative min-h-screen text-white p-6 md:p-12 font-sans">
      ...
      {/* Todo o seu conteúdo antigo está agora dentro deste 'div' */}
      <div className="relative z-10">
        
        {/* Balão (max-w-5xl) (O seu código, sem mudanças) */}
        <div className="relative border border-lime-400 p-4 md:p-8 lg:p-12 rounded-lg 
                        max-w-5xl mx-auto bg-[#1a1c1f] shadow-lg">
          
          {/* Detalhes do jogo (O seu código, sem mudanças) */}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            {/* Mini Gráficos (size 80) (O seu código, sem mudanças) */}
            ...
            {/* Gráfico Geral (size 160) (O seu código, sem mudanças) */}
