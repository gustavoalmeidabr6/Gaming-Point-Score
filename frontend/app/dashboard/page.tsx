...
import { useState } from 'react'; // useEffect foi removido
import Image from 'next/image';
import { useRouter } from 'next/navigation'; // --- ADICIONADO para navegar para a nova página
...
// --- TIPO PARA OS RESULTADOS DA BUSCA (Atualizado) ---
...
// --- PÁGINA PRINCIPAL DO DASHBOARD (LÓGICA LIMPA) ---
export default function DashboardPage() {
  ...
  // A lógica de review, selectedGame, etc. FOI REMOVIDA DAQUI.
  ...
  // A sua função de busca (sem mudanças na lógica da API)
  ...
  // --- MUDANÇA #1: handleGameClick agora navega para a nova página ---
  ...
  return (
    ...
    <main className="min-h-screen bg-[#1E2024] text-white">
      ...
      {/* Esta 'div' NÃO está mais condicional */}
      ...
      <div className="w-full bg-gray-900">
        <div className="mx-auto max-w-6xl px-4 pt-0 pb-20 sm:px-6 lg:px-8">
          ...
          {/* --- MUDANÇA #2: Removida a lógica de 'selectedGame' --- */}
          {/* O painel de review foi removido daqui */}
          <section>
            ...
            <div className="grid grid-cols-4 gap-8 md:grid-cols-4">
              ...
              {!isSearchLoading && results.length > 0 && (
                results.map((game) => (
                  <div 
                    key={game.id} 
                    onClick={() => handleGameClick(game.id)} // --- MUDANÇA #3: Isto agora NAVEGA
                    className="
